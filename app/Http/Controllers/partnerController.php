...
/*cette fonction renvoie l'ID le plus élevé présent dans la table "annonces", 
ce qui est utile si vous souhaitez connaître la dernière annonce ajoutée à la 
base de données ou si vous avez besoin de générer un nouvel identifiant unique pour une nouvelle annonce.*/
    ...
    /**Si l'utilisateur n'a pas la permission, il recevra une erreur HTTP 403. Si l'utilisateur a la permission, la page de création d'annonce sera affichée. */
